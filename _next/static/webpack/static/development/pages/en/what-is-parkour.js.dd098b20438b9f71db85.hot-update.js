...
function Header() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx("header", {
    ...
    return __jsx("li", {
      key: label,
      className: "jsx-2237549231" + " " + ((pathname === href ? 'active' : '') || ""),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 43
      },
